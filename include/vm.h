...
typedef enum {
    ...
    OP_LOAD_I,        // take an address from stack and puts back the int value from that address
    OP_LOAD_F,        // take an address from stack and puts back the double value from that address
    ...
    OP_LESSEQ_I,  // compares 2 int values from stack and puts the result on stack as int if less or equal
    OP_LESSEQ_F,  // compares 2 double values from stack and puts the result on stack as int if less or equal
    OP_GREATER_I,     // compares 2 int values from stack and puts the result on stack as int if greater
    OP_GREATER_F,     // compares 2 double values from stack and puts the result on stack as int if greater
    OP_GREATEREQ_I, // compares 2 int values from stack and puts the result on stack as int if greater or equal
    OP_GREATEREQ_F, // compares 2 double values from stack and puts the result on stack as int if greater or equal
